...
window.PRESETS = {
  ...
  "Meteor Hit": {
    ...
    cone: 0.9, coneAngle: 225, coneSpread: 9, coneLength: 1.2, coneSoft: 0.05, coneLife: 0.2,
    flash: 0.95, flashSize: 0.3, flashLife: 0.12,
    wave: 0.85, waveSpeed: 1, waveWidth: 0.1, waveLife: 0.26,
    ...
    emit2Radius: 0.05, emit2Delay: 0.38, emit2Over: 0.25, emit2Speed: 95, emit2SpeedVar: 0.6,
    emit2Gravity: -70, emit2Drag: 0.45, emit2Size: 17, emit2SizeVar: 0.5, emit2Grow: 0.8,
    emit2Life: 0.6, emit2LifeVar: 0.3, emit2FadeIn: 0.15, emit2FadeOut: 0.65,
    emit2Hue: 26, emit2Sat: 0.2, emit2Bright: 0.32, emit2Opacity: 0.3, emit2Blend: 2,
    layerDelay: "Flash:0.34,Shockwave:0.36,Lines:0.36",
    hue: 36, hueLife: -14, sat: 1, bright: 1, coreWhite: 0.4,
    glow: 0.55, duration: 1.15, fps: 24, frameSize: 5, originX: 0.56, originY: 0.58,
  },
  "Deep Freeze": {
    ...
    shatter: 0.9, shatterPieces: 28, shatterRadius: 0.1, shatterSpeed: 150,
    shatterSpin: 320, shatterGravity: 260, shatterHold: 0.05, shatterFade: 0.75,
    layerDelay: "Shatter:0.95",
    hue: 196, hueLife: 14, sat: 0.8, bright: 1, coreWhite: 0.2, blend: 1,
    glow: 0.35, duration: 1.7, fps: 24, frameSize: 5,
  },
  "Rift Tear": {
