...
window.PRESETS = {
  ...
  "Triple Tap": {
    shape: 1, count: 22, opacity: 1, emitter: 1, emitAngle: 0, emitSpread: 22,
    speed: 210, speedVar: 0.3, drag: 0.3, size: 6, life: 0.3, fadeOut: 0.5, sparkLen: 0.6,
    shots: 3, shotDelay: 0.16, shotScale: 0.85, shotSpread: 12,
    hue: 40, hueLife: -24, sat: 1, bright: 1, coreWhite: 0.7,
    glow: 0.5, duration: 1, fps: 24, frameSize: 5, originX: 0.3,
  },
  "Tesla Coil": {
    shape: 0, count: 1, opacity: 0,
  ...
  "Focus Lines": {
    shape: 0, count: 1, opacity: 0,
    lines: 1, lineCount: 26, lineInner: 0.42, lineOuter: 0.95, lineWidth: 9, lineTaper: 0.95,
  ...
  "Goo Split": {
    ...
    merge: 1, mergeThreshold: 0.45, mergeSmooth: 0.7,
  ...
  "Sun Glint": {
    shape: 0, count: 1, opacity: 0,
    flash: 0.7, flashSize: 0.16, flashLife: 1.4,
  ...
  "Corrupt Blip": {
    ...
    glitch: 1, glitchSlices: 12, glitchShift: 0.4, glitchRGB: 0.7, glitchRate: 14,
